...
class Ui_JoinDialog(QtGui.QWidget):#class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setMinimumSize(QtCore.QSize(180, 100))
        Dialog.setMaximumSize(QtCore.QSize(180, 100))
        Dialog.setFocusPolicy(QtCore.Qt.StrongFocus)
        Dialog.setModal(False)

        self.okCancle = QtGui.QDialogButtonBox(Dialog)
        self.okCancle.setGeometry(QtCore.QRect(10, 70, 161, 21))
        ...
        self.nameInput.setGeometry(QtCore.QRect(10, 40, 161, 21))
        ...
        self.addressInput.setGeometry(QtCore.QRect(10, 10, 100, 21))
        ...
        self.portInput.setGeometry(QtCore.QRect(120, 10, 51, 21))
